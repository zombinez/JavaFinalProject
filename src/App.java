...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        //
        var firstTask = "SELECT name, region, happinesRank, happinesScore, standartError, " + 
        ...
        System.out.println(m.ExecuteRequest(firstTask).get(0));
        //
        var secondTask = "SELECT name, region, happinesRank, happinesScore, standartError, economy, family, health, freedom, trust, generosity, dystopiaResidual, MIN(" +
        ...
        var thirdTask = "SELECT name, region, happinesRank, happinesScore, standartError, economy, family, " + 
            "health, freedom, trust, generosity, dystopiaResidual " + 
            "FROM Countries_happines_2015";
        var countries = m.ExecuteRequest(thirdTask);
